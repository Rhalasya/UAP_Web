...
<body>
    ...
    <div class="container">
        <div class="content" id="komik">
            <h3>Daftar Komik</h3>
            <hr>
            <table id="komikTable" class="table table-striped table-bordered">
                <thead>
                    <tr>
                        <th>Judul</th>
                        <th>Genre</th>
                ...
                <tbody>
                    <?php while ($row = $queryKomik->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td><a href="booking_komik.php?id=<?php echo $row['id'] ?>" class="btn btn-coklat">Book</a></td>
                        </tr>
                    <?php endwhile; ?>
                </tbody>
            </table>
