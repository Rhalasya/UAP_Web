...
$query = "
    SELECT booking_dvd.id AS booking_id, booking_dvd.nama_perental, data_dvd.judul, booking_dvd.jumlah, booking_dvd.booking_date, booking_dvd.status
    FROM booking_dvd 
    JOIN data_dvd ON booking_dvd.id = data_dvd.id 
    ORDER BY booking_dvd.booking_date DESC
";
...
<head>
    ...
    <title>Laporan Booking DVD</title>
    ...
    <div class="container-fluid">
        <div class="index-container">
                        ...
                        <?php if ($queryBookings->num_rows > 0): ?>
                            ...
                            while ($row = $queryBookings->fetch_assoc()): ?>
                                ...
                                <div class="modal-dialog">
                                    ...
                                    <form method="POST" action="crud_laporan_dvd.php">
                                        <input type="hidden" name="id" value="<?= $row['booking_id'] ?>">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" name="judul" value="<?= $row['judul'] ?>" placeholder="Judul DVD" readonly>
                                                    </div>

                                                    <div class="mb-3">
                                                        <label class="form-label">Jumlah</label>
                                                        <input type="text" class="form-control" name="jumlah" value="<?= $row['jumlah'] ?>" placeholder="Jumlah DVD" readonly>
                                                    </div>
            ...
            <!-- Akhir Modal Update Status -->
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="6">Tidak ada data booking DVD yang ditemukan.</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
